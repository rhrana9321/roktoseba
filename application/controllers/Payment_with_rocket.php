...
class payment_with_rocket extends CI_Controller {
	...
	public function order_confirm()
	{
		...
		$data1['bKashnumber']	 			= $this->input->post('bKashnumber');
		$data1['TxID']	 					= $this->input->post('TxID');
		$data1['paymentdate'] 	 			= date('Y-m-d');
		$data1['payment_type'] 	 			= 'Rocket';
  ...
  <tr>
    <td align="center" valign="top"><table width="800" border="0" align="center" cellpadding="1" cellspacing="0">
        ...
        <tr>
		 ...
		 <tr>
          <td align="left" colspan="5" valign="middle" bgcolor="#F7F7F7" style="border-left: 1px solid #DDDDDD;border-right: 1px solid #DDDDDD;">&nbsp;Order Payment Rocket</td>
        </tr>
		
		 <tr>
          <td align="left" colspan="5" valign="middle" bgcolor="#F7F7F7" style="border-left: 1px solid #DDDDDD;border-right: 1px solid #DDDDDD;">&nbsp;Rocket Number : '.$bKashnumber.'</td>
        </tr>
		
		<tr>
          <td align="left" colspan="5" valign="middle" bgcolor="#F7F7F7" style="border-left: 1px solid #DDDDDD;border-right: 1px solid #DDDDDD;">&nbsp;TXID : '.$TxiD.'</td>
        </tr>
