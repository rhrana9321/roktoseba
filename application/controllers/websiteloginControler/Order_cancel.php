...
class Order_cancel extends CI_Controller {
	...
	public function index()
	{
		...
		$data['neworderlist'] = $this->M_cloud->findReportorder('order_info', array('status' => 'Cancel'), 'orId desc');
		...
		$this->load->view('websiteloginview/Order_cancelPage', $data);
	}
	...
	public function order_confirm()
	{
		...
		redirect('websiteloginControler/Order_cancel');
	}
