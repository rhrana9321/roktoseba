...
class Todays_Total_orders extends CI_Controller {
	...
	public function index()
	{
		...
		$data['neworderlist'] = $this->M_cloud->findReportorder('order_info', array('paymentdate' => $current_date), 'orId desc');
		
		$data['adminuserinfo']	 = $this->M_cloud->find('superadmin', array('spId' => $auid));
		
		$this->session->set_userdata(array('msg' => ''));
		$this->load->view('websiteloginview/Todays_Total_ordersPage', $data);
	}
