...
class How_to_order extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('websiteloginview/How_to_orderPage', $data);
	}
	...
	public function store()
	{
		...
		$this->db->update('how_to_order_mange', $data, array('sliId' => $id));
			...
			$this->db->insert('how_to_order_mange', $data);
		}
		
		redirect('websiteloginControler/How_to_order');
	}
	...
	function create_thumbnail_three($fileName, $width, $height)
	{
		...
		$config['new_image']      = './uploads/How_to_order_image/'. $fileName;
	...
	public function update()
	{
		...
		$id = $this->input->post('id');
		$result = $this->M_cloud->find('how_to_order_mange', array('sliId' => $id));
	...
	public function delete($sliId)
	{
		...
		$result 	= $this->M_cloud->tbWhRow('how_to_order_mange', $where);
		$this->M_cloud->destroyAll('how_to_order_mange', $where);
