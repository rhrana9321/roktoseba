...
class Payment_with_bank extends CI_Controller {
	...
	public function order_confirm()
	{
		...
		$data1['Receipt_number']	 		= $this->input->post('Receipt_number');
		$data1['Bank_Account_number']	 	= $this->input->post('Bank_Account_number');
		$data1['paymentdate'] 	 			= date('Y-m-d');
		$data1['payment_type'] 	 			= 'Bank';
		...
		$Receipt_number         = $data1['Receipt_number'];
		$Bank_Account_Number    = $data1['Bank_Account_number'];
		...
		$customerAddress = $this->M_cloud->find('signup_user', array('signId' => $custId));
			$cusEmail = $customerAddress->d_email;
				...
				$subject 		 = 'Zazabar Order Confirmation';
  ...
  <tr>
    <td align="center" valign="top"><table width="800" border="0" align="center" cellpadding="1" cellspacing="0">
        ...
        <tr>
		 ...
		 <tr>
          <td align="left" colspan="5" valign="middle" bgcolor="#F7F7F7" style="border-left: 1px solid #DDDDDD;border-right: 1px solid #DDDDDD;">&nbsp;Order Payment Bank</td>
        </tr>
		
		 <tr>
          <td align="left" colspan="5" valign="middle" bgcolor="#F7F7F7" style="border-left: 1px solid #DDDDDD;border-right: 1px solid #DDDDDD;">&nbsp;Receipt number : '.$Receipt_number.'</td>
        </tr>
		
		<tr>
          <td align="left" colspan="5" valign="middle" bgcolor="#F7F7F7" style="border-left: 1px solid #DDDDDD;border-right: 1px solid #DDDDDD;">&nbsp;Bank Account Number : '.$Bank_Account_Number.'</td>
        </tr>
		<tr>
          <td align="left" colspan="5" valign="middle" bgcolor="#F7F7F7" style="border-left: 1px solid #DDDDDD;border-right: 1px solid #DDDDDD;">&nbsp;Bank Name : '.$Bank_Name.'</td>
        </tr>
