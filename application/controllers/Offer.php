...
class Offer extends CI_Controller {
	...
	public function index($onset =0)
	{
		...
		$data['subcategoryByproductList'] = $this->M_cloud->tbOn25ObyResult('webproduct_mange_table', array('Offer'=> 'Offer'), $onset, 'wproid desc');
		$data['onset'] 			= $onset;
		$config['base_url'] 	= base_url('Offer/index');
		$config['total_rows'] 	= $this->M_cloud->tbRowCount('webproduct_mange_table', array('Offer'=> 'Offer'));
