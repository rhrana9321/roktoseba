...
class payment_with_bkash extends CI_Controller {
  ...
  <tr>
    <td align="center" valign="top"><table width="800" border="0" align="center" cellpadding="1" cellspacing="0">
        ...
        <tr>
		 ...
		 <tr>
          <td align="left" colspan="5" valign="middle" bgcolor="#F7F7F7" style="border-left: 1px solid #DDDDDD;border-right: 1px solid #DDDDDD;">&nbsp;Order Payment Bkash</td>
        </tr>
		
		 <tr>
          <td align="left" colspan="5" valign="middle" bgcolor="#F7F7F7" style="border-left: 1px solid #DDDDDD;border-right: 1px solid #DDDDDD;">&nbsp;Bkash Number : '.$bKashnumber.'</td>
        </tr>
