		...
		<div class="col-md-10 col-sm-12 col-xs-12 main category_Bysub_category subcategory_Bysub_subcategory search_product_Value subsubcategory_Bysub_subcategory"  style="padding-left:20px; padding-right:0px; min-height:700px; border-left:1px #ecc766 solid;">
		   <div style="border-left:1px #ecc766 solid; height:100%; min-height:700px;">
			...
			<div class="row" align="" style="padding-top:50px; margin-left:0px;">
				  <div class="col-md-6">
				  <h3 class="white-text" style="font-size:18px;"> Enter the security number</h3>
                      <hr class="hr-light">
                      
                       <?php if(!empty($mailsendList)){ ?>
					  <span style="color:#FF0000; font-size:14px;">The security number has been sent to your email!</span>
					  <hr class="hr-light">
					  <?php } else { ?>
					  <?php }?>
					   ...
					   <?php if(!empty($verifycodeList)){ ?>
					  <span style="color:#FF0000; font-size:14px;">Your security number does not match!</span>
					  <hr class="hr-light">
					  <?php } else { ?>
					  <?php }?>
				  	 ...
				  	 <form action="<?php echo site_url("Id_verify/forgottenPasswordAction"); ?>" method="post" enctype="multipart/form-data">
					<div class="form-group">
					  <label for="usr"> PIN Number :</label>
					  <input type="text" name="verifcode" class="form-control" id="verifcode" placeholder="PIN Number" required>
					  <input type="hidden" name="veriemail" class="form-control" id="veriemail" placeholder="" required>
					</div>
					 <span class="red"><?php if(!empty($verifierror)){echo $verifierror; } ?></span>
