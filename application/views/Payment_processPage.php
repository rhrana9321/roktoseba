			...
			<div class="row" align="" style="padding-top:50px; margin-left:0px;">
				...
				<?php }?>
                      ...
                      <hr class="hr-light">
				  	 ...
				  	 <form action="<?php echo site_url('Payment_method'); ?>" method="post" enctype="multipart/form-data">
						  <div class="custom-control custom-radio custom-control-inline">
							<input type="radio" class="custom-control-input" id="payment_name" name="payment_name" value="ONLINE_PAYMENT">
				...
				<?php }?>
							...
							<div>
							 <?php if(($language_check == 'EN') || (empty($language_check))) { ?>
				Pay  Securely By Credit  Or Debit card or internet banking throgh SSL commerz Secure Servers.
				<?php } else if($language_check == 'BN') { ?>
				নিরাপদভাবে ক্রেডিট বা ডেবিট কার্ড বা এসএসএল কমার্জ সিকিউর সার্ভারগুলির মাধ্যমে ইন্টারনেট ব্যাংকিংয়ের মাধ্যমে প্রদান করুন।
				<?php }?>
							</div>
						  </div>
						  <hr class="hr-light">
						  <div class="custom-control custom-radio custom-control-inline">
							<input type="radio" class="custom-control-input" id="payment_name" name="payment_name" value="OFFLINE_PAYMENT">
				...
				<?php }?>
						  ...
						  <hr class="hr-light">
						  <div class="custom-control custom-checkbox" style="padding-bottom:50px;">
							<input type="checkbox" class="custom-control-input" id="customCheck" name="example1" required>
							<label class="custom-control-label" for="customCheck">
							
							 <?php if(($language_check == 'EN') || (empty($language_check))) { ?>
				I have read and Accept the Trems and condiations And Refund Policy 
				<?php } else if($language_check == 'BN') { ?>
				আমি শর্তাবলী এবং ফেরত নীতিটি পড়েছি এবং স্বীকার করেছি
				<?php }?>
							</label>
						  </div>
						  
						<div class="text-center mt-4" style="text-align:left; padding-bottom:100px;">
                      <button type="submit" style="background:#E3282C; color:#FFFFFF;" class="btn btn-indigo">
					  <?php if(($language_check == 'EN') || (empty($language_check))) { ?>
				Submit
				<?php } else if($language_check == 'BN') { ?>
				জমা দিন
