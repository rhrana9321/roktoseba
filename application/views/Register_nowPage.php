      ...
      <div style="border-left:1px #ecc766 solid; height:100%; min-height:700px;">
        ...
        <div class="row" align="" style="padding-top:50px; margin-left:0px;">
			 <div class="col-md-1"></div>
				  <div class="col-md-5">
				  <h3 class="white-text" style="font-size:18px;"> Sign Up</h3>
                      <hr class="hr-light">
                      <?php if(!empty($errors)){ ?>
		  <div style="padding-top:10px; color:#FF0000"><?php echo $errors; ?></div>
		  <?php } ?>
					  
					   
				  	 <form action="<?php echo site_url('Sign_up/Sing_up_action'); ?>" method="post" enctype="multipart/form-data">
					 
					 
					 
					 <input type="hidden" name="signEmail" class="form-control"  id="signEmail" placeholder="Email">
					
					<input type="hidden" name="signMobile" class="form-control" id="signMobile" readonly value="<?php echo $Mobile_number; ?>" placeholder="Mobile" required>
