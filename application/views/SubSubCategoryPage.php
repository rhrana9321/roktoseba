          ...
          <section id="how-to-order-theme"> <br>
			...
			<ol class="breadcrumb">
                 <li itemprop="itemListElement"  class="crumb">
					...
					<?php echo $catagorinameList->category_name; ?> > <?php echo $subcatagorinameList->sub_category_name; ?> > <?php echo $SubsubcatagorinameList->sub_to_sub_category_name; ?>
					<?php } else if($language_check == 'BN') { ?>
					<?php echo $catagorinameList->category_name_bn; ?> > <?php echo $subcatagorinameList->sub_category_name_bn; ?> >  <?php echo $SubsubcatagorinameList->sub_to_sub_category_name_bn; ?>
					<?php }?>
            ...
            <div class="categorySection miscCategorySection onlyMiscCategorySection">
              <div class="productPane">
				...
				<div class="col-md-3" align="center" style="font-size:16px;"><h2 class="heading" style="font-size:16px;">
					...
					<?php if(($language_check == 'EN') || (empty($language_check))) { ?>
					<?php echo $SubsubcatagorinameList->sub_to_sub_category_name; ?>
					<?php } else if($language_check == 'BN') { ?>
					<?php echo $SubsubcatagorinameList->sub_to_sub_category_name_bn; ?>
					<?php }?>
				</h2></div>
