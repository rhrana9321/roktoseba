...
<div class="container-fluid">
  ...
  <div class="row" style="padding-top:55px;">
   <div class="col-md-2 hidden-sm  hidden-xs sidenav" style="padding-left:0px;">
		...
		<div class="col-md-10 col-sm-12 col-xs-12 main category_Bysub_category subcategory_Bysub_subcategory subsubcategory_Bysub_subcategory search_product_Value"  style="padding-left:20px; padding-right:0px; min-height:700px; border-left:1px #ecc766 solid;">
		   <div style="border-left:1px #ecc766 solid; height:100%; min-height:700px;">
			...
			<div class="row" align="" style="padding-top:50px; margin-left:0px;">
				  <div class="col-md-6">
				  <h3 class="white-text" style="font-size:18px;"> Reset password</h3>
                      <hr class="hr-light">
					  
					  <?php if(!empty($eror_message)){ ?>
					  <span style="color:#FF0000; font-size:14px; padding-bottom:20px;">Your email does not match!</span>
					  <hr class="hr-light">
					  <?php } else { ?>
					  <?php }?>
					   
				  	   <form action="<?php echo site_url('web_new_password/webnewpasswordUpdate'); ?>" method="post" enctype="multipart/form-data">
					...
					<span style="color:#FF0000;" class="meg"></span>
					
					<div class="text-center mt-4" style="text-align:left; padding-bottom:100px;">
                      <button type="submit" style="background:#fdd670; color:#000000;" class="btn btn-indigo">Submit </button> 
					  </form>
