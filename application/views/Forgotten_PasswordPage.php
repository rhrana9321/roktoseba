        ...
        <div class="landingPage2">
          <section id="how-to-order-theme">
			...
			<div class="contact-us authForm" style="padding-top:20px; padding-bottom:50px;">
                ...
                <form method="post" action="<?php echo site_url("Forgotten_Password/forgottenPasswordAction"); ?>" class="popup-form" id="contactForm" onSubmit="return submitContactForm();">
                  <div class="inputContainer">
                    <input type="email" id="email" class="required has-value" name="email" value="" required/>
