      ...
      <div style="border-left:1px #ecc766 solid; height:100%; min-height:700px;">
        ...
        <div class="row" align="" style="padding-top:50px; margin-left:0px;">
			 <div class="col-md-1"></div>
				  <div class="col-md-5">
				  <h3 class="white-text" style="font-size:18px;"> Code </h3>
                      <hr class="hr-light">
					  
					   <div style="color:#FF0000; font-size:16px;"><?php echo $Send_sms; ?></div>
				  	 <form action="<?php echo site_url('Sign_up/Code_verifide'); ?>" method="post" enctype="multipart/form-data">
					 <input type="hidden" name="Send_mobile" class="form-control" value="<?php echo $Send_mobile; ?>" id="Send_mobile" required>
					 
					<input type="hidden" name="signEmail" class="form-control"  id="signEmail" placeholder="Email">
					<input type="hidden" name="signMobile"  id="signMobile" readonly value="<?php echo $Mobile_number; ?>" required>
					...
					<div class="text-center mt-4" style="text-align:left; padding-bottom:100px;">
                      <button type="submit" style="background:#fdd670; color:#000000;" class="btn btn-indigo abc">Submit </button> 
					  </form>
				  ...
				  <h3 class="white-text" style="font-size:18px;">Login to your account </h3>
				  <hr class="hr-light">
				  <h6 class="mb-3 wow fadeInLeft" data-wow-delay="0.3s">If you already have an account with us, please visit the login page to login.</h6>
                <a href="<?php echo site_url("Sign_in"); ?>" style="background:#fdd670; color:#000000;" class="btn btn-indigo">Sign In</a>
				  </div>
				  <div class="col-md-1"></div>
				</div>
