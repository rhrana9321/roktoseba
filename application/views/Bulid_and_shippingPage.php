        ...
        <div class="landingPage2">
          <section id="how-to-order-theme">
			...
			<div class="contact-us authForm" style="padding-top:20px; padding-bottom:50px;">
                <div style="background:#FF6700;color:#FFFFFF; padding-left:10px;padding-top:10px;padding-bottom:10px;font-size:16px;font-weight:bold;">
				
				<?php if(($language_check == 'EN') || (empty($language_check))) { ?>
				Billing & Shipping address
				<?php } else if($language_check == 'BN') { ?>
				বিলিং এবং শিপিংয়ের ঠিকানা
				<?php }?>
				</div>
				<div>&nbsp;</div>
		  	...
		  	if(!empty($rows)) { ?>	
			<div class="row" align="" style="padding-top:10px; margin-left:0px;">
				<form action="<?php echo site_url('Bulid_and_shipping/Address_Update'); ?>" method="post" enctype="multipart/form-data">
				  <div class="col-md-6">
				  <h3 class="white-text" style="font-size:18px;"> 
				...
				<?php }?>
					   :</label>
					  <input type="text" name="signName" class="form-control" value="<?php echo $userinfo->signName; ?>" id="signName" placeholder="Name" required>
					</div>
					<div class="form-group">
					  <label for="usr"> 
					  <?php if(($language_check == 'EN') || (empty($language_check))) { ?>
				...
				<?php }?>
					   :</label>
					  <input type="email" id="signEmail" name="signEmail" value="<?php echo $userinfo->signEmail; ?>" placeholder="Email " class="white-text form-control">
					</div>
					<div class="form-group">
					  <label for="usr"> 
					  <?php if(($language_check == 'EN') || (empty($language_check))) { ?>
				...
				<?php }?>
					   :</label>
					  <input type="text" id="signMobile" name="signMobile" value="<?php echo $userinfo->signMobile; ?>" placeholder="" class="white-text form-control" required>
					</div>
					<div class="form-group">
					  <label for="usr">
					  <?php if(($language_check == 'EN') || (empty($language_check))) { ?>
				...
				<?php }?>
					   :</label>
					  <input type="text" id="address" name="address" value="<?php echo $userinfo->address; ?>" placeholder="" class="white-text form-control" required>
					</div>
				...
				<?php }?>
                      ...
                      <hr class="hr-light">
					  <div class="row checkbox" style="padding:0px 0px 15px 15px;">
						<label><input type="checkbox" id="willbsame">
						
						  <?php if(($language_check == 'EN') || (empty($language_check))) { ?>
				Shipping address will be same.
				<?php } else if($language_check == 'BN') { ?>
				শিপিংয়ের ঠিকানা একই হবে।
				<?php }?>
						</label>
					</div>
				...
				<?php }?>
					   :</label>
					  <input type="text" name="d_name" class="form-control"  id="d_name" placeholder="" required>
					</div>
					<div class="form-group">
					  <label for="usr"> 
					  <?php if(($language_check == 'EN') || (empty($language_check))) { ?>
				...
				<?php }?>
					   ...
					   :</label>
					  <input type="email" id="d_email"  name="d_email"  placeholder="" class="white-text form-control">
					</div>
					<div class="form-group">
					  <label for="usr"> 
				...
				<?php }?>
					   :</label>
					  <input type="text" id="d_phone" name="d_phone"  placeholder="" class="white-text form-control" required>
					</div>
					<div class="form-group">
					  <label for="usr">
				...
				<?php }?>
					   :</label>
					  <input type="text" id="d_address" name="d_address" placeholder="" class="white-text form-control" required>
					</div>
					
					<div class="text-center mt-4" style="text-align:left; padding-bottom:100px; padding-top:10px;">
                      <button type="submit" style="background:#FF6700; color:#FFFFFF;" class="btn btn-indigo">
...
$(document).ready(function() {	 
  $('#willbsame').on('click', function ()
	{
		if ($(this).is(':checked') ) {
            $('#d_name').val($('#signName').val());
			$('#d_email').val($('#signEmail').val());
			$('#d_phone').val($('#signMobile').val());
