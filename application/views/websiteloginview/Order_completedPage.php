...
?>
							...
							<?php if($adminuserinfo->Order_Completed_list==1){ ?>
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									foreach($neworderlist as $v) {
										...
										<tr>
											...
											<td>
												<div class="">
													<?php if($adminuserinfo->Order_Completed_delete==1){ ?>
													<a class="red delete" href="<?php echo site_url("websiteloginControler/New_order/Complete_order/" . $v->orId); ?>">
