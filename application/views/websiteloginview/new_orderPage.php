				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">New Order Manage</li>
						</ul>
					</div>
...
?>
								<?php if($adminuserinfo->New_Order_list==1){ ?>
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									foreach($neworderlist as $v) {
										...
										<td>
												<div class="">
												    <?php if($adminuserinfo->New_Order_view==1){ ?>
													<a target="_blank" href="<?php echo site_url("websiteloginControler/new_order/Invoice_details/" . $v->orId); ?>">
														<i class="ace-icon fa fa-eye bigger-130"></i>
													</a>
													
													|
													<?php } ?>
													 <?php if($adminuserinfo->New_Order_edit==1){ ?>
													<a target="_blank" href="<?php echo site_url("websiteloginControler/new_order/Edit_Invoice_details/" . $v->orId); ?>">
														<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
													</a>
													|
													<?php } ?>
													<?php if($adminuserinfo->New_Order_delete==1){ ?>
													<a class="red delete" href="<?php echo site_url("websiteloginControler/new_order/delete/" . $v->orId); ?>">
