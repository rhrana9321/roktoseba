				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Confirm Order Manage</li>
						</ul>
					</div>
...
?>
							...
							<?php if($adminuserinfo->Order_Confirm_list==1){ ?>
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									foreach($neworderlist as $v) {
										...
										<tr>
											...
											<td>
												<div class="">
												    <?php if($adminuserinfo->Order_Confirm_View==1){ ?>
													<a  href="<?php echo site_url("websiteloginControler/new_order/Invoice_details/" . $v->orId); ?>">
														<i class="ace-icon fa fa-eye bigger-130"></i>
													</a>
													|
													<?php } ?>
													 <?php if($adminuserinfo->Order_Confirm_delete==1){ ?>
													<a class="red delete" href="<?php echo site_url("websiteloginControler/new_order/Confarm_order/" . $v->orId); ?>">
