				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">সংগঠন সদস্যগণ</li>
						</ul>
					</div>
...
?>
						<div class="row">
							...
							<div class="col-md-3"><div class="form-group">
													...
													<select class="form-control selectpicker" id="pro_cat_id2" name="pro_cat_id2" data-live-search="true">
													  ...
													  <option value="updestha_mondoli">উপদেষ্টামন্ডলী</option>
													  <option value="sudhi_mondoli">সুধীমন্ডলী</option>
													  <option value="admin_bindho">এডমিনবৃন্দ/মডারেটর </option>
													  <option value="seycha_sebok_bindho">সেচ্ছাসেবকবৃন্দ</option>
													</select>
							...
							<div class="col-md-3"><div class="form-group">
													...
													<input type="text" name="quntity2" id="quntity2"  tabindex="1" 
												class="form-control" placeholder=" ID No."  value="" />
							...
							<div class="col-md-3" style="padding-top:30px;"><div class="form-group">
														...
														<button type="submit" style="width:100%; background:#FF0000; color:#FFFFFF;" class="form-control btn btn-danger customer_idclick">Delete</button>
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                 ...
                                                 <?php
													...
													$name_songothon = 'এডমিনবৃন্দ/মডারেটর'; 
			...
			<div id="modal-form" class="modal" tabindex="-1" data-backdrop="static">
						<form id="addForm" action="<?php echo site_url('websiteloginControler/webproduct_manage/store'); ?>" enctype="multipart/form-data" method="post">
							<input type="hidden" id="id" name="id" value="<?php echo $wproid; ?>" />
							<div class="modal-dialog" style="width:680px;">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
										<h4 class="blue bigger">Add  সংগঠন</h4>
									</div>
										...
										<div class="row">
											<div class="col-xs-12 col-sm-11">
												...
												<div class="form-group">
													<label for="pro_name">সংগঠনঃ</label>
												...
												<label for="pro_name"> পদবি </label>
												<div>
												<input type="text" name="product_kg_liter_dos_bn" id="product_kg_liter_dos_bn"  tabindex="1" 
												class="form-control" placeholder=" পদবি "  value="" />
												</div>
												</div></div>
												...
												<div class="row">
												<div class="col-md-12"><div class="form-group">
												<label for="pro_name"> ID No.</label>
												<div>
												<input type="text" name="quntity" id="quntity"  tabindex="1" 
												class="form-control" placeholder=" Id No."  value="" />
												</div>
												</div></div>
												...
												<div class="form-group">
												<label for="pro_name">Mobile </label>
												<div>
												<input type="text" name="procode" id="procode"  tabindex="5" 
												class="form-control" placeholder=" Mobile "  value="" />
												</div>
												</div>
												<div class="row">
												<div class="col-md-12"><div class="form-group">
												...
												<div>
												<input type="text" name="product_kg_liter_dos" id="product_kg_liter_dos"  tabindex="5" 
...
$("#cate_id").on('change', function(){
	...
	var url   = "<?php echo site_url('websiteloginControler/webproduct_manage/CityWisearea'); ?>";
		$.ajax({
		url:url,
		type:"POST",
...
$(".class_click").on('click', function(){
	...
	var url   = "<?php echo site_url('websiteloginControler/webproduct_manage/Shorting'); ?>";
		$.ajax({
		url:url,
		type:"POST",
...
$(document).on("click", ".green", function(e)
{
	...
	var formURL = "<?php echo site_url('websiteloginControler/webproduct_manage/update'); ?>";			
		$.ajax(
		{
		url : formURL,
		type: "POST",
...
$("#pro_cat_id").on('change', function(){
	...
	var url   = "<?php echo site_url('websiteloginControler/webproduct_manage/subcateidsubcat'); ?>";
		$.ajax({
		url:url,
		type:"POST",
...
$("#pro_sub_id").on('change', function(){
	...
	var url   = "<?php echo site_url('websiteloginControler/webproduct_manage/Subsubcateidsubcat'); ?>";
		$.ajax({
		url:url,
		type:"POST",
...
function Edit_SubcateWish(pro_cat_id,pro_sub_id,subsubcate){
	...
	var urlmgs = "<?php echo site_url('websiteloginControler/webproduct_manage/Subsubcateidsubcat'); ?>";
		$.ajax({
		url:urlmgs,
		type:"POST",
		data:{pro_sub_id:pro_sub_id},
...
function Edit_cateWish(pro_cat_id,pro_sub_id){
	var pro_cat_id = pro_cat_id;
	var pro_sub_id = pro_sub_id;
	var urlmgs = "<?php echo site_url('websiteloginControler/webproduct_manage/subcateidsubcat'); ?>";
		$.ajax({
		url:urlmgs,
		type:"POST",
		data:{pro_cat_id:pro_cat_id},
...
$(".ShowNow").on('click', function(){
	...
	var url   = "<?php echo site_url('websiteloginControler/Webproduct_manage/Show_now'); ?>";
		$.ajax({
		url:url,
		type:"POST",
		data:{pro_cat_id2:pro_cat_id2,quntity2:quntity2},
		dataType: "html",
		success:function(data){
