				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Total Order Amounts</li>
						</ul>
					</div>
							...
							<?php }?>
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									foreach($neworderlist as $v) {
										$row_total = $v->total_amount;
										$total_order_amounts = $total_order_amounts +$row_total;
										?> 
									
										<tr>
											<td class="center"><?php echo $i++; ?></td>
											<td><?php echo $v->paymentdate; ?></td>
											<td><a target="_blank" href="<?php echo site_url("websiteloginControler/new_order/Invoice_details/" . $v->orId); ?>"><?php echo $v->orId; ?></a></td>
									...
									<tr>
											<td colspan="4" style="text-align:right;">Total Order Amounts </td>
											
										<td colspan="2"><?php echo $total_order_amounts; ?></td>
										</tr>
