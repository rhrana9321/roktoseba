...
@media only screen and (max-width: 500px) {
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									foreach($category_tablelist as $v) {
										...
										<tr>
											...
											<td><img height="50" src="<?php echo base_url("uploads/".$v->proimage1); ?>" /></td>
											...
											<td>
												<div class="hidden-sm hidden-xs action-buttons">
													...
													<a class="red delete" href="<?php echo site_url("websiteloginControler/category_manage/delete/" . $v->catId); ?>">
			...
			<div id="modal-form" class="modal" tabindex="-1" data-backdrop="static">
						<form id="addForm" action="<?php echo site_url('websiteloginControler/category_manage/store'); ?>" enctype="multipart/form-data" method="post">
									...
									<div class="modal-body">
										...
										<div class="row">
											<div class="col-xs-12 col-sm-11">
												...
												<div class="col-md-6"><div class="form-group">
													<label for="pro_name">Category Name BN</label>
													<div>
														<input type="text" required name="category_name_bn" id="category_name_bn"  tabindex="1" 
														class="form-control" placeholder="Category Name BN"  value="" />
													</div>
												</div></div>
												...
												<div class="row">
												<div class="col-md-6"><div class="form-group">
												<label for="comlogo">Icon Image(Size-W-200px X H-200px)</label>
												<div>
...
$(".updown").on('click', function() {
	...
	$.ajax({
		url : "<?php echo site_url('websiteloginControler/category_manage/updown'); ?>",
		type : "POST",
		dataType : 'html',
