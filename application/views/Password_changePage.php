  ...
  <div class="app catalog navOpen theme navBtn">
    <?php $this->load->view("header_part"); ?>
        ...
        <div class="landingPage2">
		  ...
		  <?php if(!empty($HelpCenterlist->proimage)){ ?>
		  <br>
            <img src="<?php echo base_url("uploads/".$HelpCenterlist->proimage); ?>" alt="" class="img-responsive">
			<br/>
			<?php } ?>
			...
			<div class="contact-us authForm" style="padding-top:20px; padding-bottom:50px;">
                ...
                <form method="post" action="<?php echo site_url('Password_change/Pass_update'); ?>" class="popup-form" id="contactForm" onSubmit="return submitContactForm();">
                  <div class="inputContainer">
                    <input type="text" id="oldpass" class="required has-value" name="oldpass" value="" required/>
				...
				<?php }?>
                  ...
                  <div class="inputContainer">
                    <input type="password" id="password" class="required has-value" name="password" value="" required/>
                    <span class="input-placeholder">
